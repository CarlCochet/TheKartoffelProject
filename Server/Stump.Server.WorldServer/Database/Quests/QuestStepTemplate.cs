...
namespace Stump.Server.WorldServer.Database.Quests
{
    ...
    public class QuestStepTemplate : IAutoGeneratedRecord, IAssignedByD2O
    {
        ...
        [NullString]
        private string ObjectiveIdsCSV
        {
        ...
        public void AssignFields(object d2oObject)
        {
            ...
            KamasScaleWithPlayerLevel = questStep.kamasScaleWithPlayerLevel;
            KamasRatio = questStep.kamasRatio;
            XpRatio = questStep.xpRatio;
