...
namespace Stump.Server.WorldServer.Database.Quests
{
    ...
    public class QuestRewardTemplate : IAutoGeneratedRecord, IAssignedByD2O
    {
        ...
        [NullString]
        private string ItemQuantitiesRewardCSV
        {
        ...
        [NullString]
        private string EmotesRewardCSV
        {
        ...
        [NullString]
        private string SpellsRewardCSV
        {
