...
namespace Stump.Server.WorldServer.Database.Characters
{
    ...
    public class CharacterRecord : IAutoGeneratedRecord, ISaveIntercepter
    {
        ...
        private string m_dragosCSV;
        private List<short> m_dragos = new List<short>();
        ...
        public int? Drago { get; set; }
        [Ignore]
        public List<short> Dragos
        {
            get
            {
                return m_dragos;
            ...
            {
                m_dragos = value;
                m_dragosCSV = m_dragos.ToCSV(",");
            }
        }
        [NullString]
        public string DragosCSV
        {
            get
            {
                return m_dragosCSV;
            ...
            {
                m_dragosCSV = value;
                m_dragos = !string.IsNullOrEmpty(m_dragosCSV) ? m_dragosCSV.FromCSV<short>(",").ToList() : new List<short>();
            }
        }
        ...
        public string OrnamentsCSV
        {
            ...
            set
            {
                ...
                m_ornaments = !string.IsNullOrEmpty(m_ornamentsCSV)
                    ? m_ornamentsCSV.FromCSV<ushort>(",").ToList()
                    : new List<ushort>();
            }
        }
