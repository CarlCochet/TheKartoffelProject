...
namespace Stump.Server.WorldServer.Game.Maps.Paddocks
{
    public class Paddock
    {
        ...
        {
            var properties = new PaddockInstancesInformations((short)MaxOutdoorMount, (short)MaxItems, this.IsPublicPaddock() ? new PaddockBuyableInformations[0] : new[] { new PaddockBuyableInformations(Price, Locked) });
