...
namespace Stump.Server.WorldServer.Game.Fights.Triggers
{
    public class Wall : MarkTrigger
    {
        ...
        public override bool CanTrigger(FightActor actor)
        {
            ...
            if (bomb == null)
                return true;
            SummonedBomb triggerBomb = actor as SummonedBomb;
            if (triggerBomb != null && bomb.IsFriendlyWith(triggerBomb) && bomb.MonsterBombTemplate == triggerBomb.MonsterBombTemplate
