    ...
    public class ExoItem : BasePlayerItem
    {
        ...
        public override bool Drop(BasePlayerItem dropOnItem)
        {
            ...
            if (Effects.Any(x => x.EffectId == EffectsEnum.Effect_AddRange || x.EffectId == EffectsEnum.Effect_AddRange_136))
            {
                ...
                {
                    Owner.SendServerMessage("Algo malo ocurrió : Este item ya posee PO.");
                    return false;
                }
            }
            else
            {
                ...
                {
                    Owner.SendServerMessage("Algo malo ocurrió : Este item ya posee un PA o PM");
                    return false;
                }
            }
            ...
            Owner.SendServerMessage("Tu exomageo ha sido exitoso, cambia de pj para que se activen los cambios!");
