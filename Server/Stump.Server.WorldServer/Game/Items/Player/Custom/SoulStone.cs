...
namespace Stump.Server.WorldServer.Game.Items.Player.Custom
{
    ...
    public sealed class SoulStone : BasePlayerItem
    {
        ...
        {
            FightPvM fightPvM = Owner.Fighter.Fight as FightPvM;
            if (fightPvM != null && fightPvM == obj && !fightPvM.IsPvMArenaFight && Owner.Fighter.HasWin() && Owner.Fighter.HasState((int)SpellStatesEnum.CHERCHEUR_DAMES_2))
            {
