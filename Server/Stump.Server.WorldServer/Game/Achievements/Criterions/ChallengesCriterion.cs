...
{
    public class ChallengesCriterion : AbstractCriterion<ChallengesCriterion, DefaultCriterionData>
    {
        // FIELDS
        ...
        {
            return this.Points == this.GetPlayerValue(character.Achievement);
        }
        ...
        {
            return (ushort)Math.Min(this.MaxValue, player.Owner.Achievement.GetRunningCriterion(this));
        }
    }
}
