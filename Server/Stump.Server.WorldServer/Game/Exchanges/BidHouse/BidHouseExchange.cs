...
namespace Stump.Server.WorldServer.Game.Exchanges.BidHouse
{
    public class BidHouseExchange : IExchange
    {
        ...
        public SellerBuyerDescriptor GetBuyerDescriptor()
            => new SellerBuyerDescriptor(BidHouseManager.Quantities, Types, BidHouseManager.TaxPercent, BidHouseManager.TaxModificationPercent, (sbyte)MaxItemLevel, Character.Level, Npc.Id, (short)BidHouseManager.UnsoldDelay);
