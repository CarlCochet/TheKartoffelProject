...
namespace Stump.Server.WorldServer.Game.Actors.Stats
{
    ...
    public class StatsFields
    {
        ...
        public void Initialize(MonsterGrade record)
        {
            ...
            Fields.Add(PlayerFields.Strength, new StatsData(Owner, PlayerFields.Strength, stats /*record.Strength*/));            
            ...
            Fields.Add(PlayerFields.Chance, new StatsData(Owner, PlayerFields.Chance, stats/*record.Chance*/));
            Fields.Add(PlayerFields.Agility, new StatsData(Owner, PlayerFields.Agility, stats/*record.Agility*/));
            Fields.Add(PlayerFields.Intelligence, new StatsData(Owner, PlayerFields.Intelligence, stats/*record.Intelligence*/));
