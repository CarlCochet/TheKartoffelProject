    ...
    public class WorldServer : ServerBase<WorldServer>
    {
        ...
        public override void Initialize()
        {
            ...
            if (BaseServer.Settings.InactivityDisconnectionTime.HasValue)
                IOTaskPool.CallPeriodically(BaseServer.Settings.InactivityDisconnectionTime.Value / 4 * 1000, DisconnectAfkClient);
        }
        ...
        {
            IEnumerable<WorldClient> enumerable =
                FindClients(client => client.Account != null && client.Account.Id == accountId);
        ...
        {
                return Clients.FindAll(predicate).ToArray();
        }
