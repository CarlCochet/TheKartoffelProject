...
namespace Stump.Server.BaseServer.Network
{
    public abstract class BaseClient : IPacketReceiver, IDisposable, IClient
    {
        ...
        public readonly LimitedStack<Pair<DateTime, Message>> m_messagesHistory = new LimitedStack<Pair<DateTime, Message>>(MessagesEntriesLimit);
        ...
        [Variable(DefinableRunning = false)]
        ...
        public string IP => Socket == null ? "null" : ((IPEndPoint)this.Socket.RemoteEndPoint).Address.ToString();
        ...
        public byte[] sendBuffer, receiveBuffer;
        public BigEndianReader buffer;
        const int bufferLength = 8192;
        public MessagePart currentMessage;
        public abstract void DisconectedCallBack(IAsyncResult asyncResult);
        public abstract void ReceiveCallBack(IAsyncResult asyncResult);
        public abstract void SendCallBack(IAsyncResult asyncResult);
        ...
        public virtual void Send(Message message)
        {
            ...
            //    Console.WriteLine(string.Format("(SEND) {0} : {1}", (object)this, (object)message));
        }
        public void Dispose()
        {
            // Dispose
        ...
        public void ThreatBuffer()
        {
            ...
            if (!this.currentMessage.Build(this.buffer))
                return;
        ...
        public event EventHandler<ConnectedEventArgs> ConnectedServer;
        ...
        public void OnDisconnected(DisconnectedEventArgs e)
        {
            if (Disconnected != null)
                Disconnected(this, e);
            Console.WriteLine("client disconnected ({0})", IP);
        }
        ...
        public void OnDataSended(DataSendedEventArgs e)
        {
            if (DataSended != null)
                DataSended(this, e);
        }
        ...
        public static void Clear()
        {
            ...
            if (Environment.OSVersion.Platform != PlatformID.Win32NT)
                return;
            BaseClient.SetProcessWorkingSetSize(Process.GetCurrentProcess().Handle, -1, -1);
        }
