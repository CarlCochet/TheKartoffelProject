    ...
    public class CellData
    {
        ...
        public CellData(BigEndianReader _reader, sbyte mapVersion, int id)
        {
            ...
            if (mapVersion >= 9)
            {
                ...
                if(this._mov)
                {
                    //Console.WriteLine("Walkable Cell");
                }
                this._nonWalkableDuringFight = (tmpbytesv9 & 2) != 0;
                this._nonWalkableDuringRP = (tmpbytesv9 & 4) != 0;
                if(_nonWalkableDuringFight || _nonWalkableDuringRP)
                {
                   // Console.WriteLine("nonWalkableDuringFight or nonWalkableDuringRP Cell");
                }
                this._los = (tmpbytesv9 & 8) == 0;
                if(_los)
                {
                    //Console.WriteLine("LineOfSight Cell");
                }
                this._blue = (tmpbytesv9 & 16) != 0;
                this._red = (tmpbytesv9 & 32) != 0;
                if(_blue || _red)
                {
                   // Console.WriteLine("Red or Blue Cell");
                }
