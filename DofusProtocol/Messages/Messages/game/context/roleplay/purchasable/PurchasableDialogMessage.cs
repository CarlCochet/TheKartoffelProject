...
namespace Stump.DofusProtocol.Messages
{
    public class PurchasableDialogMessage : Message
    {
        ...
        public PurchasableDialogMessage(bool buyOrSell, bool secondHand, int purchasableId, uint purchasableInstanceId, long price)
        {
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            if (purchasableInstanceId < 0 || purchasableInstanceId > 4294967295)
