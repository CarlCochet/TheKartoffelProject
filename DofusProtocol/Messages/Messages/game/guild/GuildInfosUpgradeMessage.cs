...
namespace Stump.DofusProtocol.Messages
{
    public class GuildInfosUpgradeMessage : Message
    {
		...
		private sbyte maxTaxCollectors;
		private sbyte count;
		private short taxCollectorHealth;
		private short taxCollectorDamageBonuses;
		private short boost;
		private short[] tAX_COLLECTOR_SPELLS;
		private IEnumerable<sbyte> enumerable;
		...
		public GuildInfosUpgradeMessage(sbyte maxTaxCollectors, sbyte count, short taxCollectorHealth, short taxCollectorDamageBonuses, short taxCollectorPods, short taxCollectorProspecting, short taxCollectorWisdom, short boost, short[] tAX_COLLECTOR_SPELLS, IEnumerable<sbyte> enumerable)
		{
			this.maxTaxCollectors = maxTaxCollectors;
			this.count = count;
			this.taxCollectorHealth = taxCollectorHealth;
			this.taxCollectorDamageBonuses = taxCollectorDamageBonuses;
			this.taxCollectorPods = taxCollectorPods;
			this.taxCollectorProspecting = taxCollectorProspecting;
			this.taxCollectorWisdom = taxCollectorWisdom;
			this.boost = boost;
			this.tAX_COLLECTOR_SPELLS = tAX_COLLECTOR_SPELLS;
